...
function RouterFunction($stateProvider) {
  $stateProvider
    ...
    .state('medicalCompare', {
      url: '/employers/:id/medical/med-compare',
      templateUrl: 'js/ng-views/employers/compare.html',
...
function CategoryFactoryFunction($resource) {
  return $resource('api/medical/:type/:category/:subcategory', {}, {
    update: { method: 'PUT' }
  })
}
